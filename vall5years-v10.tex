...
Figure \ref{fig:demosalime} plots the conversion rate for different the features: APOE, educational level, familiar AD (father or mother), income level calculated using residency and age and diet.
...
Figure \ref{fig:multico} shows the Pearson correlation between conversion to MCI and some features cognitive complaints, depression (positive correlation) and income level-education and use of new technologies (negative correlation.
...
Figure \ref{fig:anovabox} shows the box plot for some of the features that reject the null hypothesis.
...
\section{Predictive analytics using Machine Learning} 
\label{se:mod}
...
\subsubsection{Multinomial Logistic regression or Softmax}
